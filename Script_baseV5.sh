...
PERF_COMMAND="perf stat -o /tmp/perf.out -I 1000 -e cycles,instructions,cache-misses,LLC-load-misses"
...
APP_SPLASH3=("kernels/lu" "kernels/lu")
APP_SPLASH3_NAMES=("lu contiguous" "lu nocontiguous")
